...
public class Pool
{
    // I am so proud of this code, that i will leave it for you to see this great oprimization idea
    // instead of game object list i use componet list, and now I dont need to GetComponent so much
    // if Ill need to do something with the object after it was pulled up
    // all is needed now is a single simple check (if component is Something something)....
    public Pool() { }
